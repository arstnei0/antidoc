...
export const toggleTheme = () => {
	...
	for (let i in classList) {
		if (classList[i] === "d") document.documentElement.classList.replace("d", newClassName)
		else if (classList[i] === "l") document.documentElement.classList.replace("l", newClassName)
	}
}
